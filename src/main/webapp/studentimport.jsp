...
<%
	...
	String uploadUrl = blobstoreService.createUploadUrl("/student");
%>
<html>
...
<body>
	<div id="main">
		...
		<div id="site_content">
		<a href="/viewstudent" class="btn btn-primary">View Existing
				Students</a>
			<div class="contentgrid">
				<header class="content_header">
					<h3 class="content_title">Student</h3>
				</header>
				<div class="content_body">

					<h5>Student Import</h5>
					<br>
					<form action="<%=uploadUrl%>" method="post"
						enctype="multipart/form-data">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">Choose File(Only .txt files)</span> <input
									class="form-control" type="file" name="inputfile"
									accept="text/plain">
							</div>
						</div>
