...
<body>
	<div id="main">
		...
		<div id="site_content" style="padding-bottom: 300px;">
			<div class="contentgrid">
				<header class="content_header">
					<h3 class="content_title">Home</h3>
				</header>
				<div class="content_body">Welcome to the Administrative panel
					of electronic voting system of University of Bamberg</div>
			</div>
