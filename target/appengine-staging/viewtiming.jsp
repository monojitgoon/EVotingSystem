...
<%@ page import="uni.bamberg.appengine.model.Timing"%>
<%
	List<Timing> timings = (List<Timing>) request.getAttribute("timingsList");
%>
<html>
...
<body>
	<div id="main">
		...
		<div id="site_content">
			<a href="timing.jsp" class="btn btn-primary">Create new Timing</a>
			<div class="contentgrid">

				<header class="content_header">
					<h3 class="content_title">Existing Timing</h3>
				</header>
					...
					<table class="table table-striped">
						<thead>
							<tr>
								...
								<th class="col-md-4" scope="col">start</th>
						...
						<tbody>
							...
							%>
							<tr>
								<td class="col-md-4"><%=timing.getFromdate()%></td>
								<td class="col-md-4"><%=timing.getTodate()%></td>
